...
class AudioRendererSink {
 public:
  ...
  using OutputDeviceInfoCB = std::function<void(OutputDeviceInfo)>;
 ...
 protected:
  // friend class rtc::RefCountedObject<AudioRendererSink>;
