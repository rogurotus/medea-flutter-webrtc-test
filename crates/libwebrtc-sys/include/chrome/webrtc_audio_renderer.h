...
#include "web_media_stream_audio_renderer.h"
#include "third_party/blink/renderer/modules/modules_export.h"
// #include "third_party/blink/renderer/platform/allow_discouraged_type.h"
// #include "third_party/blink/renderer/platform/mediastream/media_stream_descriptor.h"
// #include "third_party/blink/renderer/platform/timer.h"
#include "webrtc_source.h"
...
class MODULES_EXPORT WebRtcAudioRenderer
 ...
 public:
  ...
  using TranscribeAudioCallback = std::function<void(std::unique_ptr<media::AudioBus>, int, media::ChannelLayout)>;
  ...
  WebRtcAudioRenderer(
      ...
      std::string media_stream_descriptor,
      WebLocalFrame& web_frame,
      // const base::UnguessableToken& session_id,
      const std::string& device_id,
      std::function<void()> on_render_error_callback);
  ...
  WebMediaStreamAudioRenderer*
  CreateSharedAudioRendererProxy(std::string media_stream_descriptor);
 ...
 private:
  ...
  int GetCurrentRenderTime() override;
  ...
  class AudioStreamTracker {
   ...
   private:
    ...
    AudioStreamTracker* check_alive_timer_;
    ...
    int last_audio_level_log_time_;

    AudioStreamTracker* weak_this_;
 ...
 private:
  ...
  void OnPlayStateChanged(std::string media_stream_descriptor, PlayingState* state);
  ...
  // to log messages.
  std::string media_stream_descriptor_id_;
  ...
  std::function<void()> on_render_error_callback_;
