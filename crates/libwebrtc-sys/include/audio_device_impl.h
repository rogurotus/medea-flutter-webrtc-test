...
#define WEBRTC_INCLUDE_INTERNAL_AUDIO_DEVICE true
...
class AudioDeviceModuleImplMy : public AudioDeviceModuleForTest {
 public:
  enum PlatformType {
  ...
  AudioDeviceModuleImplMy(AudioLayer audio_layer,
                        TaskQueueFactory* task_queue_factory);
  ~AudioDeviceModuleImplMy() override;
