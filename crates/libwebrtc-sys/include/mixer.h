...
class AudioMixerMy : public AudioMixer {
 public:
  struct SourceStatus;
  ...
  static rtc::scoped_refptr<AudioMixerMy> Create(
  ...
  ~AudioMixerMy() override;

  AudioMixerMy(const AudioMixerMy&) = delete;
  AudioMixerMy& operator=(const AudioMixerMy&) = delete;
 ...
 protected:
  AudioMixerMy(std::unique_ptr<OutputRateCalculator> output_rate_calculator,
                 bool use_limiter,
