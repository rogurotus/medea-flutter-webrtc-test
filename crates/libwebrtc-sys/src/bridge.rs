...
pub(crate) mod webrtc {
    ...
    unsafe extern "C++" {
        ...
        #[must_use]
        pub fn get_rtp_sender_capabilities(peer_connection_factory: &PeerConnectionFactoryInterface, kind: MediaType) -> UniquePtr<RtpCapabilities>;
        
        /// Returns the [`RtpCodecCapabilityContainer`] of the provided
        /// [`RtpCapabilities`].
        #[must_use]
        pub fn rtp_capabilities_codecs(capability: &RtpCapabilities,) -> Vec<RtpCodecCapabilityContainer>;

        /// Returns the [`RtpHeaderExtensionCapability`] of the provided
        /// [`RtpCapabilities`].
        #[must_use]
        pub fn rtp_capabilities_header_extensions(capability: &RtpCapabilities,) -> Vec<RtpHeaderExtensionCapabilityContainer>;

        /// Returns the `payload_type` of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn preferred_payload_type(capability: &RtpCodecCapability) -> Box<OptionI32>;
        
        /// Returns the [`ScalabilityMode`]'s of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn scalability_modes(capability: &RtpCodecCapability) -> Vec<ScalabilityMode>;

        /// Returns the `mime_type` of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn rtc_codec_mime_type(capability: &RtpCodecCapability) -> UniquePtr<CxxString>;

        /// Returns the `name` of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn rtc_codec_name(capability: &RtpCodecCapability) -> UniquePtr<CxxString>;

        /// Returns the `kind` of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn rtc_codec_kind(capability: &RtpCodecCapability) -> MediaType;

        /// Returns the `clock_rate` of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn rtc_codec_clock_rate(capability: &RtpCodecCapability) -> Box<OptionI32>;

        /// Returns the `num_channels` of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn rtc_codec_num_channels(capability: &RtpCodecCapability) -> Box<OptionI32>;

        /// Returns the `parameters` of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn rtc_codec_parameters(capability: &RtpCodecCapability) -> UniquePtr<CxxVector<StringPair>>;

        /// Returns the [`RtcpFeedback`]'s of the provided
        /// [`RtpCodecCapability`].
        #[must_use]
        pub fn rtc_codec_rtcp_feedback(capability: &RtpCodecCapability) -> Vec<RtcpFeedbackContainer>;

        /// Returns the [`RtcpFeedbackType`] of the provided
        /// [`RtcpFeedback`].
        #[must_use]
        ...
        /// [`RtcpFeedback`].
        #[must_use]
        pub fn rtcp_feedback_message_type(feedback: &RtcpFeedback) -> Box<OptionI32>;

        /// Returns the `uri` of the provided
        /// [`RtpHeaderExtensionCapability`].
        #[must_use]
        pub fn header_extensions_uri(header_extensions: &RtpHeaderExtensionCapability) -> UniquePtr<CxxString>;

        /// Returns the `preferred_id` of the provided
        /// [`RtpHeaderExtensionCapability`].
        #[must_use]
        pub fn header_extensions_preferred_id(header_extensions: &RtpHeaderExtensionCapability) -> Box<OptionI32>;

        /// Returns the `preferred_encrypted` of the provided
        /// [`RtpHeaderExtensionCapability`].
        #[must_use]
        pub fn header_extensions_preferred_encrypted(header_extensions: &RtpHeaderExtensionCapability) -> bool;

        /// Returns the [`RtpTransceiverDirection`] of the provided
        /// [`RtpHeaderExtensionCapability`].
        #[must_use]
        pub fn header_extensions_direction(header_extensions: &RtpHeaderExtensionCapability) -> RtpTransceiverDirection;
    }
