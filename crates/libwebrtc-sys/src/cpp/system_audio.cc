...
// std::vector<uint8_t> dataall;
// std::vector<uint8_t> dataall2;
// std::vector<uint8_t>* dataall3 = &dataall;
// uint64_t  old = 0;
...
// 		std::cout << wfex->nSamplesPerSec << std::endl;
// 		std::cout << wfex->nChannels << std::endl;
...
//             res.push_back(outSample);
//         }
//         UpdateFrame((const int16_t *)(res.data()), 480, 48000, 2);
// 	};
